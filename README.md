...
base linux linux-firmware grub efibootmgr less vim opendoas openssh zsh bat dms-shell-niri dunst eza fakeroot fastfetch firefox firewalld fd foot fzf gcc git hyprland hyprlock hyprpaper hyprshot i3lock iwd kitty grim lf make man-db mpv neovim noto-fonts noto-fonts-emoji npm otf-cascadia-code otf-fira-mono otf-fira-sans otf-font-awesome p7zip pamixer powerline powerline-fonts pulsemixer python-psutil qutebrowser ripgrep rofi rust rust-analyzer satty slurp tmux ttf-anonymous-pro ttf-fira-code ttf-font-awesome ttf-liberation ttf-hack-nerd ttf-iosevka-nerd ttf-iosevkaterm-nerd ttf-jetbrains-mono-nerd ttf-nerd-fonts-symbols ttf-nerd-fonts-symbols-mono unzip upower vulkan-intel waybar which wl-clipboard wl-kbptr woff-fira-code wtype yazi xdg-desktop-portal-hyprland zellij zsh-autosuggestions zsh-completions zsh-syntax-highlighting kubectl adw-gtk-theme lxappearance qt6ct
